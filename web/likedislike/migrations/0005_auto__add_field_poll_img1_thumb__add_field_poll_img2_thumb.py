...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'likedislike.poll': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'717c2301-5e9a-448c-925b-ee3a73a9efcc'", 'unique': 'True', 'max_length': '150', 'primary_key': 'True'}),
        ...
        'likedislike.user': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7da6e81f-eb07-4a32-8ec6-26ebc945abfc'", 'unique': 'True', 'max_length': '150'})
        },
        'likedislike.vote': {
