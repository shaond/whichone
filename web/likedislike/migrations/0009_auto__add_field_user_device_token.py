...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('likedislike_user', 'device_token', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.device_token'
        db.delete_column('likedislike_user', 'device_token')
    ...
    models = {
        ...
        'likedislike.poll': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9a2987ad-8528-44c5-96ab-f8f7bc61e8df'", 'unique': 'True', 'max_length': '150', 'primary_key': 'True'}),
        ...
        'likedislike.user': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'device_token': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'karma': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0fa857ef-0944-47d6-b59e-765f35f8a2a4'", 'unique': 'True', 'max_length': '150', 'primary_key': 'True'})
        },
        'likedislike.vote': {
